      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-8">
        <div className="max-w-xl space-y-3">
          ...
          <p className="text-sm leading-7 text-[var(--muted)]">
            {locale === "ar"
              ? "هنيني نسخة MVP لسوق خدمات منزلية موثوقة في وهران، مع تصفح بسيط، ملفات مزودين واضحة، حجز بالتاريخ والوقت، وتأكيد عبر واتساب."
              : "Henini est un MVP de marketplace de services à domicile pour Oran, avec navigation simple, profils fiables, réservation datée et confirmation via WhatsApp."}
          </p>
        </div>
