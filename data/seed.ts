...
export const reviews: Review[] = [
  {
    ...
    bookingId: "booking-1",
    customerName: "أمين",
    reviewerPhone: "+213 699 00 11 22",
    rating: 5,
    ...
    providerReply: "شكراً على ثقتك. يسعدني أن الخدمة كانت واضحة وسريعة.",
    providerReplyStatus: "approved",
    providerReplyCreatedAt: "2026-03-08T10:30:00.000Z",
  ...
  },
  {
    ...
    bookingId: "booking-2",
    customerName: "Nora",
    reviewerPhone: "+213 770 10 20 30",
    rating: 5,
  ...
  },
  {
    ...
    bookingId: "booking-3",
    customerName: "ريم",
    reviewerPhone: "+213 556 90 11 77",
    rating: 4,
    ...
    interactionVerified: true,
    moderationReason: null,
    providerReply: "شكراً على الملاحظة. سأبقى جاهزة لأي صيانة موسمية لاحقاً.",
    providerReplyStatus: "pending",
    providerReplyCreatedAt: "2026-03-12T14:10:00.000Z",
